...
- [ ] 1.1 WindowPosにto_window_coordsメソッドを追加
...
- [ ] 1.2 (P) Win32 APIによるスタイル・DPI情報取得の実装
...
- [ ] 1.3 AdjustWindowRectExForDpiによる座標変換の実装
...
- [ ] 2.1 apply_window_pos_changesシステムへの座標変換統合
