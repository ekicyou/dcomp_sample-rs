...
- [ ] 1.2 (P) DPIコンポーネントのpubエクスポート追加
  - モジュールの公開APIにDPIコンポーネントを追加する
  - _Requirements: 5.3_

- [ ] 2. WindowHandle作成時のDPI自動付与
- [ ] 2.1 WindowHandleフックでDPIコンポーネントを自動挿入する
...
- [ ] 3. WM_DPICHANGEDメッセージ処理
- [ ] 3.1 ウィンドウプロシージャでDPIコンポーネントを更新する
...
- [ ] 4. DPIからArrangementへの伝搬とコード整理
- [ ] 4.1 レイアウトシステムにDPI変更検知を追加する
...
- [ ] 4.2 (P) 未使用のDpiTransform構造体を削除する
