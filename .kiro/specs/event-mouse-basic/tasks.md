...
- [ ] 5. 統合テスト
- [ ] 5.1 コンポーネント単体テストを実装する
  - マウスバッファのサンプル蓄積・上限テスト
  - 速度計算の精度テスト
  - ボタンバッファの状態記録テスト
  - _Requirements: 1, 3, 5A_

- [ ] 5.2 Enter/Leave 検出テストを実装する
