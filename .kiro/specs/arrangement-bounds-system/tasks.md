...
- [ ] 2. Arrangementコンポーネントの拡張
- [ ] 2.1 Arrangementにsizeフィールドを追加する
...
- [ ] 3. GlobalArrangementコンポーネントの拡張
- [ ] 3.1 GlobalArrangementを構造体化しboundsフィールドを追加する
...
- [ ] 3.2 既存のGlobalArrangementアクセスコードを修正する
  - `cargo build --all-targets`でコンパイルエラーを確認
...
- [ ] 4. バウンディングボックス計算の実装 (P)
- [ ] 4.1 (P) 軸平行矩形変換関数を実装する
...
- [ ] 4.2 GlobalArrangementのtrait実装を拡張する
...
- [ ] 5. バリデーションとエラーハンドリング (P)
- [ ] 5.1 (P) サイズとスケールのバリデーションを実装する
