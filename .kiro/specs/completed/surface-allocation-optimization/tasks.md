...
- [x] 2.1 deferred_surface_creation_systemを拡張する
...
- [x] 2.2 sync_surface_from_arrangementシステムを廃止する
  - スケジュール登録からシステムを削除
...
- [x] 3.1 cleanup_surface_on_commandlist_removedシステムを新規作成する
...
- [x] 3.2 スケジュールにSurface削除システムを登録する
