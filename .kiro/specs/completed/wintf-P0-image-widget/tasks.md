...
- [x] 1.2 (P) WintfTaskPool Resource の実装
...
- [x] 1.3 drain_task_pool_commands システムの実装
...
- [x] 3.1 パス解決ユーティリティの実装
  - 実行ファイル基準のパス解決関数を作成
  - 絶対パスはそのまま、相対パスは実行ファイルディレクトリを基準に解決
  - _Requirements: 2.7_

- [x] 3.2 load_bitmap_source 関数の実装
...
- [x] 3.3 InsertBitmapSourceResource Command の実装
...
- [x] 4.1 on_bitmap_source_add フックの実装
...
- [x] 4.2 on_bitmap_source_remove フックの実装
...
- [x] 5.1 draw_bitmap_sources システムの実装
...
- [x] 5.2 invalidate_dependent_components システムへの統合
