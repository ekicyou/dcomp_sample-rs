...
"#;
    ...
    sources
        .insert(rune::Source::new("source1", source1).expect("Failed to create source1"))
        .expect("Failed to add source1");
    sources
        .insert(rune::Source::new("source2", source2).expect("Failed to create source2"))
...
"#;
    ...
    sources
        .insert(rune::Source::new("main", source).expect("Failed to create source"))
...
"#;
    ...
    sources
        .insert(rune::Source::new("main", &combined).expect("Failed to create source"))
        .expect("Failed to add source");
