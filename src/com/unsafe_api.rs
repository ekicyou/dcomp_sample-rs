...
use winapi::um::d3dcommon::{D3D_FEATURE_LEVEL, D3D_SHADER_MACRO, ID3DBlob, ID3DInclude};
...
#[link(name = "kernel32")]
extern "system" {
    pub fn CreateEventA(lpEventAttributes: *const SECURITY_ATTRIBUTES,
                        bManualReset: BOOL,
                        bInitialState: BOOL,
                        lpName: LPCSTR)
                        -> HANDLE;
...
extern "system" {
    pub fn D3DCompile(pSrcData: LPCVOID,
                      ...
                      -> HRESULT;
    pub fn D3DCompile2(pSrcData: LPCVOID,
                       SrcDataSize: SIZE_T,
                       pSourceName: LPCSTR,
                       pDefines: *const D3D_SHADER_MACRO,
                       pInclude: *mut ID3DInclude,
                       ...
                       ppErrorMsgs: *mut *mut ID3DBlob)
                       -> HRESULT;
    pub fn D3DCompileFromFile(pFileName: LPCWSTR,
                              pDefines: *const D3D_SHADER_MACRO,
                              pInclude: *mut ID3DInclude,
                              pEntrypoint: LPCSTR,
                              pTarget: LPCSTR,
                              ...
                              ppErrorMsgs: *mut *mut ID3DBlob)
                              -> HRESULT;
    pub fn D3DCompressShaders(uNumShaders: UINT,
    ...
    pub fn D3DDecompressShaders(pSrcData: LPCVOID,
                                SrcDataSize: SIZE_T,
                                uNumShaders: UINT,
                                uStartIndex: UINT,
                                pIndices: *mut UINT,
                                ...
                                -> HRESULT;
    pub fn D3DDisassemble(pSrcData: LPCVOID,
                          SrcDataSize: SIZE_T,
                          Flags: UINT,
                          szComments: LPCSTR,
    ...
    pub fn D3DDisassembleRegion(pSrcData: LPCVOID,
                                SrcDataSize: SIZE_T,
                                Flags: UINT,
                                szComments: LPCSTR,
                                ...
                                ppDisassembly: *mut *mut ID3DBlob)
                                -> HRESULT;
    pub fn D3DGetBlobPart(pSrcData: LPCVOID,
                          SrcDataSize: SIZE_T,
                          Part: D3D_BLOB_PART,
                          Flags: UINT,
                          ppPart: *mut *mut ID3DBlob)
                          -> HRESULT;
    pub fn D3DGetDebugInfo(pSrcData: LPCVOID,
                           SrcDataSize: SIZE_T,
                           ppDebugInfo: *mut *mut ID3DBlob)
                           -> HRESULT;
    pub fn D3DGetInputAndOutputSignatureBlob(pSrcData: LPCVOID,
                                             SrcDataSize: SIZE_T,
                                             ppSignatureBlob: *mut *mut ID3DBlob)
                                             -> HRESULT;
    pub fn D3DGetInputSignatureBlob(pSrcData: LPCVOID,
                                    SrcDataSize: SIZE_T,
                                    ppSignatureBlob: *mut *mut ID3DBlob)
                                    -> HRESULT;
    pub fn D3DGetOutputSignatureBlob(pSrcData: LPCVOID,
                                     SrcDataSize: SIZE_T,
                                     ppSignatureBlob: *mut *mut ID3DBlob)
                                     -> HRESULT;
    pub fn D3DGetTraceInstructionOffsets(pSrcData: LPCVOID,
                                         SrcDataSize: SIZE_T,
                                         Flags: UINT,
                                         ...
                                         -> HRESULT;
    pub fn D3DPreprocess(pSrcData: LPCVOID,
                         SrcDataSize: SIZE_T,
                         pSourceName: LPCSTR,
                         pDefines: *const D3D_SHADER_MACRO,
                         pInclude: *mut ID3DInclude,
    ...
    pub fn D3DReflect(pSrcData: LPCVOID,
                      SrcDataSize: SIZE_T,
                      pInterface: REFIID,
                      ppReflector: *mut *mut c_void)
                      -> HRESULT;
    pub fn D3DReflectLibrary(pSrcData: LPCVOID,
                             SrcDataSize: SIZE_T,
                             riid: REFIID,
                             ppReflector: *mut LPVOID)
                             -> HRESULT;
    // pub fn D3DReturnFailure1();
    pub fn D3DSetBlobPart(pSrcData: LPCVOID,
                          SrcDataSize: SIZE_T,
                          Part: D3D_BLOB_PART,
                          Flags: UINT,
                          pPart: LPCVOID,
                          ...
                          -> HRESULT;
    pub fn D3DStripShader(pShaderBytecode: LPCVOID,
                          BytecodeLength: SIZE_T,
                          uStripFlags: UINT,
                          ppStrippedBlob: *mut *mut ID3DBlob)
                          -> HRESULT;
    pub fn D3DWriteBlobToFile(pBlob: *mut ID3DBlob,
                              pFileName: LPCWSTR,
                              bOverwrite: BOOL)
                              -> HRESULT;
}
